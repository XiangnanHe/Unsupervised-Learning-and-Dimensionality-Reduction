...
public class Br_Randomprojection {
    public static void main(String args[]) throws Exception{
        //load dataset
        //DataSource source = new DataSource("letter_rp.arff");
        //DataSource source = new DataSource("letter.arff");
        DataSource source = new DataSource("wisconsin.arff");
        ...
        FileWriter writer = new FileWriter("BR_rp_accuracy.csv", true);
