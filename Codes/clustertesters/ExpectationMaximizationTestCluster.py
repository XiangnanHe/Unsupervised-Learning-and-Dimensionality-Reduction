...
class ExpectationMaximizationTestCluster():
    ...
    def plot(self, ll, homogeneity, completeness, rand, bic, aic):
            ...
            np.savetxt("BC_EM_SSE_output.csv", ll, delimiter = ",")
            #plt.show()
            ...
            np.savetxt("BC_EM_Homogeneity_output.csv", homogeneity, delimiter = ",")
            #plt.show()
            ...
            np.savetxt("BC_EM_Completeness_output.csv", completeness, delimiter = ",")
            #plt.show()
            ...
            np.savetxt("BC_EM_BIC_output.csv", bic, delimiter = ",")
            #plt.show()
            ...
            np.savetxt("BC_EM_AIC_output.csv", aic, delimiter = ",")
            plt.show()