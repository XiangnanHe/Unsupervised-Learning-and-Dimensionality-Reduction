...
class KMeansTestCluster():
    ...
    def plot(self, meandist, homogeneity, completeness, rand, silhouettes):
            ...
            plt.ylabel('Average within cluster Sum of Squared Error')
            plt.title('Breast Cancer-Kmeans-Average within cluster SSE')
            np.savetxt("KMeansTestCluster_SSE_output.csv", meandist, delimiter = ",")
            #plt.show()
            ...
            np.savetxt("KMeansTestCluster_Homogeneity_output.csv", homogeneity, delimiter = ",")
            #plt.show()
            ...
            np.savetxt("KMeansTestCluster_Completeness_output.csv", completeness, delimiter = ",")
            plt.show()
